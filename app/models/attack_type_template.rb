class AttackTypeTemplate < ActiveRecord::Base
  ...
  validates :name, format: { with: /\A[a-zA-Zа-яА-Я0-9]+\z/, message: "доступны только кириллица и латинница" },length: { in: 2..20 }
  ...
  # validates :crit_dmg, numericality: {greater_than_or_equal_to: 1}
end
